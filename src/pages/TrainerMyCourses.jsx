    ...
    return(
            <div>
                ...
                <Card sx={{ width: "15%" }}>
                    ...
                    <CardContent>
                    <Typography gutterBottom variant="h5" component="div">Yoga</Typography>
                    <Typography variant="body2" color="text.secondary">This is description</Typography>
                    <Typography variant="body2" color="text.secondary">Duration: 30 days</Typography>
                    <Typography variant="body2" color="text.secondary">Price: 1000 Rs</Typography>
                    </CardContent>
                    <CardActions>
